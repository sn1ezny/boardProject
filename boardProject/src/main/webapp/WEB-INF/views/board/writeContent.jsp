...
<meta charset="UTF-8">
<title>Write - Board Project</title>
<!-- CSS & JS -->
...
<h1>글쓰기</h1>
<form class="form-control" action="${pageContext.request.contextPath }/writePro" method="post" enctype="multipart/form-data">
<table class="table" id="notice">
<tr><td>이름</td>
    <td><input class="form-control" type="text" id="mem_id" name="mem_id" value="${sessionScope.id }" readonly></td></tr>
<tr><td>제목</td>
    <td><input class="form-control" type="text" id="subject" name="subject"></td></tr>
<tr><td>파일</td>
    <td><input class="form-control" type="file" id="file" name="file"></td></tr>    
<tr><td>내용</td>
    <td><textarea class="form-control" id="content" name="content" rows="10" cols="20"></textarea></td></tr>
</table>

<button class="form-control btn btn-outline-dark m-sm-1 d-flex" type="submit">글쓰기</button>
